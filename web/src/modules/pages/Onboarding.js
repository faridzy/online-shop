...
class Onboarding extends PureComponent {
  ...
  render() {
    const steps = [
      /* 1. Welcome to Online Shop */
      <Grid alignCenter={true} style={{ height: '100%', textAlign: 'center', color: white }}>
        {/* Left - Headline and info */}
        <GridCell>
          <H1 font="secondary" style={{ textShadow: textLevel1 }}>Welcome to Online Shop</H1>
      ...
      <Grid alignCenter={true} style={{ height: '100%', textAlign: 'center', color: white }}>
        ...
        <GridCell>
          ...
          <H6 style={{ marginTop: '0.5em' }}>Subscribe to your Online Shop!</H6>
